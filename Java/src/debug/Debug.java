...
public class Debug {
	...
	private boolean USE_INPUT_FILE = true;
	 ...
	 * @param startText 배열을 출력하기전에 출력할 문구들
	 */
	...
	public static void printHR(char c) {
		if (!instance.DEBUG)
			return;
		printHR(c, instance.DEFAULT_HR_CNT);
	}
	...
	public static void printHR() {
		if (!instance.DEBUG)
			return;
		printHR(instance.DEFAULT_HR_CHAR, instance.DEFAULT_HR_CNT);
	}
	// *******************************************END/etc
}
